...
async function handleCreateTransaction(args) {
    const { company_id, transaction_date, description, reference, lines } = args;
  ...
  `;
    const data = (await graphqlRequest(mutation, { input: { company_id, transaction_date, description, reference, lines } }, true));
    return {
